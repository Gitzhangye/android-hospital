...
/*图片字段doctorPhoto参数接收*/
    ...
    public String AddDoctor() {
        ...
        try {
            ...
            /*处理图片上传*/
            String doctorPhotoFileName = ""; 
       	 	if(doctorPhotoFile != null) {
       	 		InputStream is = new FileInputStream(doctorPhotoFile);
       			String fileContentType = this.getDoctorPhotoFileContentType();
       			if(fileContentType.equals("image/jpeg")  || fileContentType.equals("image/pjpeg"))
       				doctorPhotoFileName = UUID.randomUUID().toString() +  ".jpg";
       			else if(fileContentType.equals("image/gif"))
       				doctorPhotoFileName = UUID.randomUUID().toString() +  ".gif";
       			else {
       				ctx.put("error",  java.net.URLEncoder.encode("上传图片格式不正确!"));
       				return "error";
       			}
       			File file = new File(path, doctorPhotoFileName);
            ...
            if(doctorPhotoFile != null)
            	doctor.setDoctorPhoto("upload/" + doctorPhotoFileName);
            else
