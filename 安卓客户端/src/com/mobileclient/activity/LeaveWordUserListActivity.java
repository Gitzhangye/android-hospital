...
public class LeaveWordUserListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		queryConditionLeaveWord = new LeaveWord();
		queryConditionLeaveWord.setTitle("");
		queryConditionLeaveWord.setUserObj(username);
		queryConditionLeaveWord.setReplyTime("");
	...
	private void setViews() {
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	intent.setClass(LeaveWordUserListActivity.this, LeaveWordDetailActivity.class);
	...
	protected void dialog() {
		Builder builder = new Builder(LeaveWordUserListActivity.this);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == 1) {
			// 添加留言信息
			Intent intent = new Intent();
			intent.setClass(LeaveWordUserListActivity.this, LeaveWordUserAddActivity.class);
			startActivity(intent);
			LeaveWordUserListActivity.this.finish();
		} else if (item.getItemId() == 2) {
			/*返回主界面*/
			Intent intent = new Intent();
			intent.setClass(LeaveWordUserListActivity.this, MainMenuUserActivity.class);
			startActivity(intent);
			LeaveWordUserListActivity.this.finish();
		}
		return true; 
