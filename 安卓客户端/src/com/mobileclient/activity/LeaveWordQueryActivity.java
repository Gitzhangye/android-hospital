...
public class LeaveWordQueryActivity extends Activity {
	// 声明查询按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.leaveword_query);
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					...
					queryConditionLeaveWord.setReplyDoctor(ET_replyDoctor.getText().toString());
					/*操作完成后返回到留言管理界面*/ 
					Intent intent = new Intent();
					intent.setClass(LeaveWordQueryActivity.this, LeaveWordListActivity.class);
					Bundle bundle = new Bundle();
					bundle.putSerializable("queryConditionLeaveWord", queryConditionLeaveWord);
					intent.putExtras(bundle);
					startActivity(intent);  
					LeaveWordQueryActivity.this.finish();
				} catch (Exception e) {}
			}
			});
	}
