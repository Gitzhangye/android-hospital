			...
			public void onClick(View v) {
				try {
					...
					if(ET_education.getText().toString().equals("")) {
						Toast.makeText(DoctorEditActivity.this, "学历输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_visiteTimes.getText().toString().equals("")) {
						Toast.makeText(DoctorEditActivity.this, "每日出诊次数输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_memo.getText().toString().equals("")) {
						Toast.makeText(DoctorEditActivity.this, "附加信息输入不能为空!", Toast.LENGTH_LONG).show();
